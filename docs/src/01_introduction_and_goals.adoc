...
| Auftraggeber | Dominik Witschard | Erwartet eine funktionsfähige Software, die die Anforderungen erfüllt und die Ziele erreicht.
| Entwickler | Mathias Vogel | Legt Wert darauf, dass das Projekt gut strukturiert ist, damit man sich im Code schnell zurechtfindet. Er erwartet, dass wichtige Abläufe durch Tests abgesichert sind, um bei Updates keine bestehenden Funktionen zu zerschiessen.
|===
